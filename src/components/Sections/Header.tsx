...
const DesktopNav: FC<{
  ...
  return (
    <header
      className="fixed top-0 z-50 hidden w-full bg-neutral-500/50 p-4 backdrop-blur sm:block"
      id={headerID}
    >
  ...
  return (
    <>
      <button
        ...
        className="fixed z-40 flex w-full flex-row-reverse rounded-md bg-transparent p-2 py-4 pr-4
        ring-offset-gray-800/60 backdrop-blur hover:text-sky-500 focus:outline-none focus:ring-0 focus-visible:ring-2 focus-visible:ring-pink-600 focus-visible:ring-offset-2 sm:hidden"
        onClick={toggleOpen}
      >
